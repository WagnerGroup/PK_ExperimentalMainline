 ...
 */
doublevar GMTM_sampler::lnwMTM_I(Point & y, Point & x, Array1 <doublevar> & translate, doublevar & tstep) {
  doublevar lnGBack = 0;
  for (int d=0; d<3; d++) {
...
doublevar GMTM_sampler::lnwMTM_INV(Point & y, Point & x, Array1 <doublevar> & translate, doublevar & tstep) {
  doublevar lnGForw = 0;
  for (int d=0; d<3; d++) {
